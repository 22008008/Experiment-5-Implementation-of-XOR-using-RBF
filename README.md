...
step 4:
index[1]: similarity of point with peak2 index[2]: Bias input (1) Y: Output associated with the input (shape: (4, )) W is calculated using the same equation we use to solve linear regression using a closed solution (normal equation).

step 5:
This part is the same as using a neural network architecture of 2-2-1,

step 6:
2 node input (x1, x2) (input layer) 2 node (each for one peak) (hidden layer) 1 node output (output layer)
...
https://user-images.githubusercontent.com/93427345/201344219-d96a0ddf-b724-4a95-9658-4760b54cbf35.png
